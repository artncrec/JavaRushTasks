    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                double chang1, chang2;
                if (stock1.get("open") != null)
                    chang1 = (double) stock1.get("last") - (double) stock1.get("open");
                else
                    chang1 = (double) stock1.get("change");
                if (stock2.get("open") != null)
                    chang2 = (double) stock2.get("last") - (double) stock2.get("open");
                else
                    chang2 = (double) stock2.get("change");
                int result = 0;
                if ((result = name1.compareTo(name2)) != 0)
                    return result;
                else
